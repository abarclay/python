...
echo "minute,number_of_messages" >/tmp/out
# I actually copied the sample messages file to messages in this dir
cat messages |while read month day mytime
do
  # original solution had incorrect regex here
  # would have added debugging lines as shown here (commented)
  ...
  do
    ...
    # so much for them not caring about syntax
    echo "$rest,$count"
  done >>/tmp/out
